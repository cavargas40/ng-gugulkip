...
describe('TodoService', () => {
  ...
  describe('#save(Todo)', () => {
    it('should automatically assign and incrementing id', inject([TodoService], (service: TodoService) => {
      let todo1 = new Todo({ title: 'Hello 1', complete: false });
      let todo2 = new Todo({ title: 'Hello 2', complete: true });
      service.addTodo(todo1);
      service.addTodo(todo2);
  ...
  describe('#updateTodoById(id, values)', () => {
    it('should return todo with the correspoonding id and updated data', inject([TodoService], (service: TodoService) => {
